...
public class UserRestController {
    ...
    public Integer getMovieRate(@PathVariable String userName , @PathVariable String imdbId){
          return ratingService.getRating(userName,imdbId);
    }

    @PostMapping("rate/{userName}/{imdbId}/{rating}")
    public void rateMovie(@PathVariable String userName,@PathVariable String imdbId,@PathVariable Integer rating){
